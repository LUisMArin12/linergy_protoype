...
import { generateFaultPDF } from '../../lib/reportUtils';
import type { Falla } from '../../lib/supabase';
...
`.trim();
  ...
  const normalizeEstadoToDbEnum = (estado: string): Falla['estado'] => {
    // Puede venir ya como enum DB (ABIERTA, EN_ATENCION, CERRADA) o como label UI
