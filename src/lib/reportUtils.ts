...
export function generateFaultPDF(falla: Falla, linea: Partial<Linea> | null) {
...
export function copyFaultText(falla: Falla, linea: Partial<Linea> | null) {
  const text = generateFaultText(falla, linea);
  navigator.clipboard.writeText(text);
}

function generateFaultText(falla: Falla, linea: Partial<Linea> | null): string {
